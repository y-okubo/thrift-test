...
public class Types implements org.apache.thrift.TBase<Types, Types._Fields>, java.io.Serializable, Cloneable, Comparable<Types> {
  ...
  static {
    schemes.put(StandardScheme.class, new TypesStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TypesTupleSchemeFactory());
  }
  ...
  public Types setShortValue(short short_value) {
    this.short_value = short_value;
    setShortValueIsSet(true);
    return this;
  }
  ...
  public Types setIntValue(int int_value) {
    this.int_value = int_value;
    setIntValueIsSet(true);
    return this;
  }
  ...
  public Types setLongValue(long long_value) {
    this.long_value = long_value;
    setLongValueIsSet(true);
    return this;
  }
  ...
  public Types setDoubleValue(double double_value) {
  ...
  public Types setBoolValue(boolean bool_value) {
  ...
  public Types setStringValue(String string_value) {
  ...
  public Types setListValue(List<String> list_value) {
  ...
  public Types setSetValue(Set<String> set_value) {
  ...
  public Types setMapValue(Map<String,Integer> map_value) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof Types)
      return this.equals((Types)that);
    return false;
  }

  public boolean equals(Types that) {
    if (that == null)
      return false;
  ...
  private static class TypesStandardSchemeFactory implements SchemeFactory {
    public TypesStandardScheme getScheme() {
      return new TypesStandardScheme();
    }
  }

  private static class TypesStandardScheme extends StandardScheme<Types> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, Types struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Types struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TypesTupleSchemeFactory implements SchemeFactory {
    public TypesTupleScheme getScheme() {
      return new TypesTupleScheme();
    }
  }

  private static class TypesTupleScheme extends TupleScheme<Types> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, Types struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, Types struct) throws org.apache.thrift.TException {
